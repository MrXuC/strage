...
robot_state_pkg_path = "/home/aicrobo/Documents/ROS/unware_project/src/basketball_strage/scripts"	#用于加载自己写的模块，请将他改为自己的相应模块
linear_move_speed = 0.8		#设置直线速度
linear_move_stop_tolerance = 0.01	#设置误差值


turn_angular_speed = 0.8	#设置转弯的速度
turn_angular_scale = 1.0	#速度比例值  最终速度=turn_angular_speed * turn_angular_scale
turn_augular_stop_tolerance = 5.0	#角度值，代表停止的误差值
<<<<<<< HEAD
>>>>>>> d41aa20b485db43a3c212e87195b10342618c153
=======
>>>>>>> d41aa20b485db43a3c212e87195b10342618c153
